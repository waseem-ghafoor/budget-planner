  ...
  <div class="container">
    <div class="row">
      <div class="col-12 right-align">
        <h2><strong>Cookie Policy for budgetroot.</strong></h2>

        <p>This is the Cookie Policy for budgetroot., accessible from www.budgetroot.com</p>
        ...
        <ul>
        <li>Email: info@budgetroot.com</li>
