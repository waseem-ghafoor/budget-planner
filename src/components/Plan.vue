                    ...
                    <div class="pricing-item col-12 col-lg-4 mb-5">
                        <div class="pricing-item-inner shadow-lg p-4 rounded h-100">
                            <div class="pricing-item-header text-center">
                                ...
                                <div v-if="is_free_plan_subscribed"><button id='free_plan' v-on:click="plan_subscribe" class="btn btn-primary theme-btn-primary">Try BudgetRoot for Free</button></div>
                    ...
                    <div class="pricing-item pricing-item-highlighted col-12 col-lg-4 mb-5">
                        <div class="pricing-item-inner shadow-lg p-4 rounded-bottom position-relative h-100">
                            ...
                            <div class="pricing-item-header text-center">
                                ...
                                <div v-if="is_plus_plan_subscribed"><button id='plus_plan' v-on:click="plan_subscribe" class="btn btn-primary theme-btn-primary" >Subscribe</button></div>
                            </div><!--//pricing-item-header-->
                            <hr>
                            <div class="pricing-item-body">
                                <ul class="list-unstyled">
                    ...
                    <div class="pricing-item col-12 col-lg-4 mb-lg-5">
                        <div class="pricing-item-inner shadow-lg p-4 rounded h-100">
                            <div class="pricing-item-header text-center">
                                ...
                                <div v-if="is_prime_plan_subscribed"><button id='prime_plan' v-on:click="plan_subscribe" class="btn btn-primary theme-btn-primary">Subscribe</button></div>
                            </div><!--//pricing-item-header-->
                            <hr>
                            <div class="pricing-item-body">
                                <ul class="list-unstyled">
