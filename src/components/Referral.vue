  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        ...
        <div class=" shadow-lg" style="padding: 5px;">
          <p>Invite your friends to BudgetRoot.</p>
              <div class="fb-share-button fb-xfbml-parse-ignore" data-href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.facebook.com%2FBudgetRoot-119862366419756">Share on Facebook</a></div>
        </div>
...
export default {
  ...
  computed: {
    whatsappInviteText() {
      return "https://wa.me/?text=I+have+a+referral+code+for+budgetroot+plus+account.+Enter+this+code+after+registering+to+budgetroot.%0D%0A%0D%0AReferral+code%3A+" + this.user_access.referring_token + "%0D%0A%0D%0Abudgetroot.+is+the+budget+planner+project+designed+during+the+quarantine+period.+Planning+your+budget+will+make+sure+to+pass+any+critical+stages+and+have+a+peaceful+future.";
    },
  },
  methods: {
