               ...
               <div class="form-wrapper shadow-lg single-col-max-width mx-auto p-5">
                  <form @submit="handleSubmit" id="contact-form" class="contact-form" method="post" action="">
                    ...
                    <div class="form-row">
                          ...
                          <hr><p>Consider supporting <a href="https://ko-fi.com/budgetroot"> us.</a> We would love to make BudgetRoot.com a better tool for you and your family! Please email us to <a href="mailto:info@budgetroot.com">info@budgetroot.com</a></p>                   
                      </div><!--//form-row-->
                  </form>
               </div>
          </div><!--//container-->
